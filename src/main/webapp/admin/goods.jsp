            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <ul class="pagination">
                    ...
                    <c:forEach begin="1" end="${pageSumNumber}" step="1" var="i">
                        <c:if test="${i==page+1}"><li class="page-item active"><a class="page-link" href="toAdminGoodsServlet?start=${i-1}">${i}</a></li></c:if>
                        <c:if test="${i!=page+1}"><li class="page-item"><a class="page-link" href="toAdminGoodsServlet?start=${i-1}">${i}</a></li></c:if>
                    </c:forEach>
                    <c:if test="${page<pageSumNumber-1}">
                        <li class="page-item"><a class="page-link" href="toAdminGoodsServlet?start=${page+1}">下一页</a></li>
                    </c:if>
                </ul>
            </div>
            <!-- Goods Table End -->
