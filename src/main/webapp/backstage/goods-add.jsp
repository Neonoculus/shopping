...
<body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <form action="doAddGoodsServlet" id="myForm" method="post">
                    <div class="row mb-5">
                        <div class="col-lg-6">
                            <!-- PRODUCT SLIDER-->
                                            ...
                                            aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="swiper-slide h-auto swiper-thumb-item swiper-slide-visible swiper-slide-next"
                                                        ...
                                                        <img class="w-100" id="upPhoto2" src="" alt="...">
                                                    </div>
                                                </div>
                                                <div>
                                                    <button type="button" class="btn btn-sm btn-secondary" onclick="clearImageContent(this)"
                                                    ...
                                                    <div class="swiper-slide h-auto swiper-thumb-item swiper-slide-visible"
                                                        ...
                                                        <img class="w-100" id="upPhoto3" src="" alt="...">
                                                    </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="swiper-slide h-auto swiper-thumb-item  swiper-slide-visible"
                                                        ...
                                                        <img class="w-100" id="upPhoto4" src="" alt="...">
                                                    </div>
                                                </div>
                                            <input type="hidden" name="c_id" id="c_id" value="">
                                            <input type="hidden" name="m_id" id="m_id" value="${merchant.m_id}">
                        ...
                        <div class="col-lg-6">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-5" style="padding-left: 0;">
                                    <input type="text" class="form-control" id="goods-name" name="goods-name" value="">
                                </div>
                            </div>
                            ...
                            <div class="row d-flex align-items-center mb-3" >
                                ...
                                <div class="row col-sm-7" style="padding-left: 0;" id="tags-container">
                            ...
                            <div class="row mb-3" style="padding-left:10px;">
                                <button type="submit" class="btn btn-primary col-sm-2">确认添加</button>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <script>
        ...
        document.getElementById('goods-type').addEventListener('change', function() {
            var selectedCategoryId = this.value; // 获取选中的商品类别的 c_id

            document.getElementById('c_id').value = selectedCategoryId;
            var url = 'doGetTagByCategoryServlet?category=' + selectedCategoryId; // 构造请求URL
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState == 4) {
                    if (xhr.status == 200) {
                        // 请求成功的处理逻辑
                        var tags = JSON.parse(xhr.responseText); // 假设返回的是一个 JSON 数组，每个元素是一个包含 t_id 和 name 的对象
                        ...
                        tags.forEach(function(tag) {
                            ...
                            var checkboxId = tag.t_id;
                            var checkbox = '<div class="col col-2">' +
                                '<input class="form-check-input" type="checkbox" name="tag" id="' + checkboxId + '">' +
                                '<label class="form-check-label" for="' + checkboxId + '">' + tag.name + '</label>' +
                                '</div>';
